...
--
-- Host: 127.0.0.1
-- Creato il: Giu 11, 2023 alle 16:43
...
(1, './img/anethum.jpg', 'Anethum', 'L\'altezza di queste piante annuali (ma in alcuni casi anche biennali[2]) varia da 0,2 a 1 m (massimo 1,5 m). La forma biologica è terofita scaposa (T scap), ossia sono piante che differiscono dalle altre forme biologiche poiché, essendo fondamentalmente annuali, superano la stagione avversa sotto forma di seme; sono inoltre munite di asse fiorale eretto e spesso privo di (o con poche) foglie. Tutta la pianta è glauca e aromatica con un odore particolarmente intenso.', 1),
(2, './img/solanum.jpg', 'Solanum dulcamara', 'Fusto in basso legnoso e ramosissimo, in alto erbaceo, scandente; rami con pubescenza appressata. Foglie triangolari con picciolo alato di 2-3 cm e lamina triangolare di 3-6 X 5-10 cm, le superiori composte, con 1 In tutto il territorio : C.scun lato del picciolo. ', 2),
(3, './img/morella.jpeg', 'Morella comune', 'Fusto eretto, ascendente, con 2 strie longitudinali. Foglie con picciolo parzialmente alato (1-3 cm) e lamina asimmetrica, lanceolata a ovata (3-5 X 5-8 cm). Fiori in cime (3-)5-10flore; calice conico 2.5 mm; corolla bianca lunga 6 mm, diam. 7 mm; bacca sferica (6-7 mm) verde e poi nera-lucida.', 2),
(4, './img/datura_stramonium.jpg', 'Datura stramonium', 'Fusto prostrato o ascendente-dicotomo, pubescente. Foglie alterne con picciolo di 2-4 cm e lamina largamente ovata 6-13 X 10-15 cm, con grossi denti acuti; base troncata. Fiori solitari ascellari su peduncoli di 3-10 mm, alla fruttificazione lignificati; ', 2),
